...
const char *gengetopt_args_info_description = "  Check File is a program the verifies if the file extension correct.\n			\n  Valid Extension: PDF, GIF, JPG, PNG, MP4, ZIP, HTML\n  Usage: ./checkFile [options] [filename]\n			\n  Made with <3 by: Ivo Afonso Bispo <2200672> | Mariana Mariana <2200672>";

const char *gengetopt_args_info_help[] = {
  "  -h, --help          Print help and exit",
  "  -V, --version       Print version and exit",
  "\n Group: checkfile-options\n  list of options for checkFile",
  "  -f, --file=STRING   fich",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->checkfile_options_group_counter = 0 ;
}
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  write_multiple_into_file(outfile, args_info->file_given, "file", args_info->file_orig, 0);
...
static void
reset_group_checkfile_options(struct gengetopt_args_info *args_info)
{
  if (! args_info->checkfile_options_group_counter)
    return;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (args_info->checkfile_options_group_counter == 0)
    {
      fprintf (stderr, "%s: %d options of group checkfile-options were given. One is required%s.\n", prog_name, args_info->checkfile_options_group_counter, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * file_list = NULL;
  int error_occurred = 0;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'f':	/* fich.  */
          ...
          if (update_multiple_arg_temp(&file_list, 
          ...
          if (!args_info->file_group)
            {
              ...
              args_info->checkfile_options_group_counter += 1;
            }
        
          break;
        case 'b':	/* fich_with_filenames.  */
        
          if (args_info->checkfile_options_group_counter && override)
            reset_group_checkfile_options (args_info);
          args_info->checkfile_options_group_counter += 1;
  ...
  if (args_info->checkfile_options_group_counter > 1)
    {
      fprintf (stderr, "%s: %d options of group checkfile-options were given. One is required%s.\n", argv[0], args_info->checkfile_options_group_counter, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
